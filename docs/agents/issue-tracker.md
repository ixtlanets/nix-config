...
- **Blocking**: use GitHub native issue dependencies. Where dependencies aren't available, use a `Blocked by: #<n>` line.
- **Frontier query**: select the first open, unassigned child with no open blockers.
