  ...
  src =
    if stdenv.isLinux && stdenv.isx86_64 then
      fetchzip {
        ...
        sha256 = "sha256-gtthhMHyZdKuqAp3oqN2DYj4ViQFnZteNrEkBn2tanA=";
        stripRoot = false;
      }
    else if stdenv.isLinux && stdenv.isAarch64 then
      fetchzip {
        url = "https://github.com/anomalyco/opencode/releases/download/v${version}/opencode-linux-arm64.tar.gz";
        sha256 = "sha256-7n4ejRb5pEeDvvz1BG78HY3k+AoNPuuPV8whGUxPRdI=";
        stripRoot = false;
      }
      ...
      fetchzip {
        ...
        sha256 = "sha256-EMFZGdrKuh5eNVezEl6sOjGsRjBhWEq6zfVRAvm4Z/0=";
        stripRoot = false;
      }
    else if stdenv.isDarwin && stdenv.isAarch64 then
      fetchzip {
        url = "https://github.com/anomalyco/opencode/releases/download/v${version}/opencode-darwin-arm64.zip";
        sha256 = "sha256-UYtieqY17nHXJX4MdoeKPkVcMeE4HCcB5E1tnlLgsCA=";
        stripRoot = false;
      }
    else
