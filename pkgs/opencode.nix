  ...
  src =
    if stdenv.isLinux && stdenv.isx86_64 then
      fetchzip {
        ...
        sha256 = "sha256-kJSbKqWsXn+yjSJupxxncsisubpz269r+5acOrru5d8=";
        stripRoot = false;
      }
    else if stdenv.isLinux && stdenv.isAarch64 then
      fetchzip {
        url = "https://github.com/anomalyco/opencode/releases/download/v${version}/opencode-linux-arm64.tar.gz";
        sha256 = "sha256-BUYl4Zp5KiUIpSZfJcFlsPV8KABziJno6r0eYsEfnfM=";
        stripRoot = false;
      }
      ...
      fetchzip {
        ...
        sha256 = "sha256-jcuPg6+mYgMjdV9VwfXai950Xz4jfnsPAnwvyGISQS4=";
        stripRoot = false;
      }
    else if stdenv.isDarwin && stdenv.isAarch64 then
      fetchzip {
        url = "https://github.com/anomalyco/opencode/releases/download/v${version}/opencode-darwin-arm64.zip";
        sha256 = "sha256-wXgWVb/5IJy3N2MPfqvEP0s9TEMcIOHPZBqyzTWDuTU=";
        stripRoot = false;
      }
    else
