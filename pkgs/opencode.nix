  ...
  src =
    if stdenv.isLinux && stdenv.isx86_64 then
      fetchzip {
        ...
        sha256 = "sha256-mANgHHCR0MmFEsTuKukJF3EbVvL6pbm+41e7L+ryUH8=";
        stripRoot = false;
      }
    else if stdenv.isLinux && stdenv.isAarch64 then
      fetchzip {
        url = "https://github.com/anomalyco/opencode/releases/download/v${version}/opencode-linux-arm64.tar.gz";
        sha256 = "sha256-FvILqMFncNEbPDe5iCnWSsEqRAedMgiJ11zj14loRKk=";
        stripRoot = false;
      }
      ...
      fetchzip {
        ...
        sha256 = "sha256-YkB2j0SyHVmaIndcM/oKqsNxzAdCyBwM148jNN20qi4=";
        stripRoot = false;
      }
    else if stdenv.isDarwin && stdenv.isAarch64 then
      fetchzip {
        url = "https://github.com/anomalyco/opencode/releases/download/v${version}/opencode-darwin-arm64.zip";
        sha256 = "sha256-zpV09u7bZyCNmVYwJZJgyac93cYOlXy0QJmAsu7++R0=";
        stripRoot = false;
      }
    else
